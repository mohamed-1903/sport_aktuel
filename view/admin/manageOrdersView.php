...
<!-- Verwaltungsbereich für Bestellungen nach Status -->
<section class="form-wrapper" style="padding: 2em; max-width: 10000px; margin: 20px;">

  <?php
  // Titel abhängig vom gewählten Status setzen
  $statusTitleMap = [
    'neu' => 'Neue Aufträge',
  ...
  <!-- Navigationsleiste zum Filtern der Bestellungen nach Status -->
  ...
  <!-- Session-basierte Nachricht anzeigen (z.B. Statusänderung bestätigt) -->
  ...
  <?php else: ?>
    <div class="table-responsive">
      <table class="cart-table" style="margin:auto;">
        ...
        <!-- Jede Bestellung als Tabellenzeile -->
        <?php foreach ($orders as $order): ?>
          <tr>
            ...
            <td>
              <!-- Bestelldetails aus JSON-Daten (z.B. Artikel mit Größe und Menge) -->
            ...
            <!-- Dropdown zur Statusänderung + optionaler Kommentar -->
            <td>
